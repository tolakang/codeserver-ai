...
# Generate all configuration files from a single source
...
# Generate config.json (all providers)
...
# Generate opencode/config.json (all providers)
...
# Generate opencode-web/opencode.json (all providers)
cat > config/opencode-web/opencode.json << EOF
{
  "server": {
    "port": 4001,
    "hostname": "0.0.0.0",
...
echo "✅ Generated all configuration files from environment variables"
